...
extern "C" __global__ void Fan1_kernel0(int lfpriv__Size, int lfpriv__t, float * a, float * m)
{
int lwpriv__i;
...
extern "C" __global__ void Fan2_kernel0(int lfpriv__Size, int lfpriv__t, float * a, float * m)
{
int lgpriv__i;
int _ti_100_201;
lgpriv__i=blockIdx.x;
...
extern "C" __global__ void Fan2_kernel1(int lfpriv__Size, int lfpriv__t, float * b, float * m)
{
int lwpriv__i;
lwpriv__i=(threadIdx.x+(blockIdx.x*64));
